...
//        if(Objects.isNull(motorista)) throw new EstacionamentoException("Não foi possível identificar o motorista.");
...
//        if(Objects.isNull(cor)) throw new NullPointerException("Carro deve informar cor.");
